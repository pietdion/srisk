...
\section{Simulating future capital shortfall and market return}\label{simulate}
...
Stress readings  alter dramatically when moving to November 2014 -- there is virtually no stress in any bank and the small amount of  stress in the system is diversifiable.    Most of the  background stress is carried by NAB with lesser contributions by BEN and aba.    All the stress in the minor bank ABAis background stress as only NAB and NAB have substantial systemic stress contributions.   Again, however, it must be emphasised that there is minimal systemic stress in the system.    Only ABAhas substantial Basel default probability, but this bank is a small player in the Australian banking scene.   Notice total debt in the banking sector  jumps about 35\% between the two dates.
